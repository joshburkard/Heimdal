...
|---------------|----------|
| [Connect-Heimdal](./Connect-Heimdal.md) | Connects to the Heimdal Security API and stores the session information in a global variable. |
| [Get-HeimdalDevice](./Get-HeimdalDevice.md) | Retrieves devices from Heimdal Security API |
| [Get-HeimdalLinuxPolicy](./Get-HeimdalLinuxPolicy.md) | Retrieves Linux policies from Heimdal Security API |
| [Get-HeimdalOSUpdate](./Get-HeimdalOSUpdate.md) | Retrieves OS updates from Heimdal Security API |
