# Contributing to Heimdal Security Module

Thank you for your interest in contributing to the Heimdal Security PowerShell module! This guide will help you understand the project structure, testing approach, and build process.
...
# 2. Clone YOUR fork
git clone https://github.com/YOUR-USERNAME/Heimdal.git
cd Heimdal

# 3. Add upstream remote to stay in sync
git remote add upstream https://github.com/joshburkard/Heimdal.git
...
git clone https://github.com/joshburkard/Heimdal.git
cd Heimdal
...
- **Heimdal/**: Built and versioned module output
...
If you want to run functional tests against an actual Heimdal Security environment:

```powershell
# Copy the sample declarations file
Copy-Item .\Tests\declarations_sample.ps1 .\Tests\declarations.ps1

# Edit declarations.ps1 with your Heimdal Security environment details
...
- Follow naming convention: `Verb-HeimdalNoun` (Heimdal is the module prefix)
...
git commit -m "Add Get-HeimdalNewFeature function"
...
```powershell
# Copy the template
Copy-Item .\Code\function-template.ps1 .\Code\Public\Get-HeimdalNewFeature.ps1

# Edit the new file
code .\Code\Public\Get-HeimdalNewFeature.ps1
```
...
- **Requires**: Access to Heimdal Security API url
...
2. **Update the test file**:
   ...
   - Add integration tests if the function interacts with Heimdal Security
...
This prevents accidentally triggering script executions or other actions in Heimdal Security during routine builds.
...
> Added Get-HeimdalNewFeature function for retrieving new feature data
```
...
- `Heimdal/<version>/Heimdal.psm1` - Compiled module
- `Heimdal/<version>/Heimdal.psd1` - Module manifest
...
```markdown
### Category Management
- `Get-HeimdalCategory` - Description of function
```
...
## Changes Made
- Added `Get-HeimdalNewFeature` function
- Updated README.md with new function
- Added test file `Test-Get-HeimdalNewFeature.Tests.ps1`

## Testing
- [ ] Structural tests pass
- [ ] Function-specific tests created and pass
- [ ] Tested against Heimdal Security environment (if applicable)

## Checklist
- [ ] Function follows naming convention (Verb-HeimdalNoun)
...
- Build artifacts in `Heimdal/` (depending on strategy)
...
2. **Use mock data** when testing without Heimdal Security environment
...
**Thank you for contributing to the Heimdal Security module!** 🎉
